...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        bgView.image = [UIImage imageNamed:@"frame"];
...
{
    NSLog(@"移开TouchUpInside");
}
// 手指在录音按钮外部时离开
-(void)recordButtonTouchUpOutside
{
    NSLog(@"移开TouchUpOutside");
}
// 手指移动到录音按钮内部
